...
Public Class RptReceive_Sum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptReceive_Sum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptReceive_Sum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptReceive_Sum = New RptReceive_Sum
        rpt.Site = Me.Site
        Return rpt
    End Function
