...
Public Class RptIssue_Sum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptIssue_Sum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptIssue_Sum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptIssue_Sum = New RptIssue_Sum
        rpt.Site = Me.Site
        Return rpt
    End Function
