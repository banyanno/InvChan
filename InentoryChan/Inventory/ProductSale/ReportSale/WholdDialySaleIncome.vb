...
Public Class WholdDialySaleIncome
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "WholdDialySaleIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.WholdDialySaleIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateReport() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWholdDialySaleIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WholdDialySaleIncome = New WholdDialySaleIncome
        rpt.Site = Me.Site
        Return rpt
    End Function
