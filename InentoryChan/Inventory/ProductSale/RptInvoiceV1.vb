...
Public Class RptInvoiceV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptInvoiceV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceV1 = New RptInvoiceV1
        rpt.Site = Me.Site
        Return rpt
    End Function
