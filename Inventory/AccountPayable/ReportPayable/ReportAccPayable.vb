...
Public Class ReportAccPayable
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.ReportAccPayable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAccPayable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAccPayable = New ReportAccPayable
        rpt.Site = Me.Site
        Return rpt
    End Function
