...
Public Class RptInvoiceSmalBK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptInvoiceSmalBK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceSmalBK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceSmalBK = New RptInvoiceSmalBK
        rpt.Site = Me.Site
        Return rpt
    End Function
