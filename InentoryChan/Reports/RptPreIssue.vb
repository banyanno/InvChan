...
Public Class RptPreIssue
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptPreIssue.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPreIssue
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPreIssue = New RptPreIssue
        rpt.Site = Me.Site
        Return rpt
    End Function
