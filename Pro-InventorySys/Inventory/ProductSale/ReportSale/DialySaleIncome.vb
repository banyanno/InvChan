...
Public Class DialySaleIncome
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.DialySaleIncome.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDialySaleIncome
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DialySaleIncome = New DialySaleIncome
        rpt.Site = Me.Site
        Return rpt
    End Function
