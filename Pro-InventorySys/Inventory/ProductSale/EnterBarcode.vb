        ...
        ElseIf e.KeyCode = Keys.Enter Then
            ...
            For Each rows As DataRow In tbl.Rows
                ...
                Else
                    ...
                    DAPreInvoice.InsertDetail(rows("ITEM_ID"), "", EmptyString(txtQTY.Text), EmptyString(TxtPrice.Text), 0, "$", 0, EmptyString(TxtPrice.Text) * EmptyString(txtQTY.Text), 0, getCurrentUserID, 0, "", False, CDbl(rows("USD_COST")), rows("ITEM_IMAGE"))
