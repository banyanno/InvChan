...
Public Class RptPreReceive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptPreReceive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPreReceive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPreReceive = New RptPreReceive
        rpt.Site = Me.Site
        Return rpt
    End Function
