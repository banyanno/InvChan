...
Public Class RptInvoiceA4BKV1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptInvoiceA4BKV1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceA4BKV1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceA4BKV1 = New RptInvoiceA4BKV1
        rpt.Site = Me.Site
        Return rpt
    End Function
