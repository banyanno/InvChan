...
Public Class RptInvoiceSmall
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Asia_Garden_Inventory_Management_System.RptInvoiceSmall.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptInvoiceSmall
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptInvoiceSmall = New RptInvoiceSmall
        rpt.Site = Me.Site
        Return rpt
    End Function
